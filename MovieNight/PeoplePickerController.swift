...
//            var copy = result
//            if activeWatcher.actorChoices.contains(where: { $0.name == nextResult.actor.name }) {
...
//      let isReady = movieWatcherViewModel.watchers.map { $0![self.movieWatcherViewModel.activeWatcherIndex].isReady }
//      rightNavBarItem.isEnabled <~ isReady
//    }
//  }
//  
//  func configureTabBar() {
//    movieWatcherViewModel.activeWatcher.signal.observeValues { watcher in
...
//    var count = movieWatcherViewModel.watchers.value![movieWatcherViewModel.activeWatcherIndex].actorChoices.count
//    guard count < 5 else {
//      return
//    }
...
//    let watcherIndex = movieWatcherViewModel.activeWatcherIndex
//    let preference = viewModel!.actorModelData.value[indexPath.row]
