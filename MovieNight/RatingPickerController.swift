...
//        return signal![self.movieWatcherViewModel.activeWatcherIndex].isReady
//      }
...
//      rightNavBarItem.isEnabled <~ movieWatcherViewModel.activeWatcher.producer.map { $0.isReady }
//    }
//  }
//
...
//      if watchers != nil {
//        let ratingChoice = self.movieWatcherViewModel.activeWatcher.value.maxRatingChoice
...
//      _ = movieWatcherViewModel.add(preference: preference, watcherAtIndex: movieWatcherViewModel.activeWatcherIndex)
//    }
//  }
...
//    _ = movieWatcherViewModel.remove(preference: preference!, watcherAtIndex: movieWatcherViewModel.activeWatcherIndex)
//  }
//  
